package no.nav.security.examples.tokensupport.clientcredentials.config;
...
class OAuth2Configuration {
    ...
    RestTemplate downstreamResourceRestTemplate(RestTemplateBuilder restTemplateBuilder,
        ...
        ClientProperties clientProperties =
                Optional.ofNullable(clientConfigurationProperties.getRegistration().get("example-clientcredentials"))
