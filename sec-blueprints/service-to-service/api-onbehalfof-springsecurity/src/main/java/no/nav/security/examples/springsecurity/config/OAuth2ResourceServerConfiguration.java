...
@EnableWebSecurity
@Configuration
class OAuth2ResourceServerConfiguration extends WebSecurityConfigurerAdapter {
     ...
     */
    OAuth2ResourceServerConfiguration(OAuth2ResourceServerProperties oAuth2ResourceServerProperties,
