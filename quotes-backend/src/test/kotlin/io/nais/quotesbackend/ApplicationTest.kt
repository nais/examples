...
class ApplicationTest {
        ...
        fun testGetQuotes() = testApplication {
                ...
                // Check that we got some quotes - don't rely on exact counts since tests may share
                // state
                kotlin.test.assertTrue(
                        jsonElement.size > 0,
                        "Expected at least one quote, but got: ${jsonElement.size}"
                )
        }
        ...
        fun testPostQuoteWithMarshalling() = testApplication {
                ...
                // Ensure your QuoteInput class is @Serializable
                val quoteRequest = QuoteInput(text = "Test Quote", author = "Author")
        ...
        fun testPostQuoteInvalidFormat() = testApplication {
                ...
                kotlin.test.assertEquals(
                        "Failed to convert request body to class io.nais.quotesbackend.QuoteInput",
